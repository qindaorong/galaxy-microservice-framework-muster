...
import com.galaxy.microservice.rocket.provider.api.annotation.MqConsumerStore;
...
public class MqConsumerStoreAspect {
	 ...
	 */
	@Pointcut("@annotation(com.galaxy.microservice.rocket.provider.api.annotation.MqConsumerStore)")
	...
	public Object processMqConsumerStoreJoinPoint(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		if (args == null || args.length == 0) {
			throw new BusinessException(TcpExceptionCode.INTERFACE_NOT_EMPTY);
		}

		if (!(args[0] instanceof List)) {
			throw new BusinessException(TcpExceptionCode.ANNOTATION_EXCEPTION);
		}
